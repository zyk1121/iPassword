...
class YKCourseTableViewCell: UITableViewCell {
    ...
    func setupEntity(data:iPassSecureData,cellType:YKCourseCellType = .normal) {
...
class YKCourseContentView:UIView {
    ...
    func setupEntity(entity:iPassSecureData) {
        courseNameLabel.text = entity.content
        progressLabel.text = entity.account
    }
